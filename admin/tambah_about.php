...
if (isset($_POST["submit"])) {
    ...
    $id_member = htmlspecialchars($_POST['id_member']);
     ...
     $sql= mysqli_query($conect,"INSERT INTO `tb_about`(`id_about`, `id_member`, `quotes`) VALUES ('','$id_member','$quotes')");
    if ($sql) {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <option value="<?=$t['id_member']; ?>"><?=$t['nama']; ?></option>
                                                    <?php } ?>
                                                </select>
                                                </div>
                                                <!-- <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="quotes" name="quotes" style="height:200px" ></textarea>
                                                </div>
