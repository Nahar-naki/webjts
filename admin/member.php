                                ...
                                <div class="d-sm-flex justify-content-between
                                    ...
                                    <div>
                                      <a class="btn btn-success  text-white
                                           btn-sm" type="button" href="tambah_member.php">
                                       <i class="mdi
                                                mdi-account-plus"></i>Add new member</a>
                                    </div>
                                </div>
                        ...
                        ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p><?=substr($row['tentang_member'], 0, 20);?>...</p>
                                                </td>
                                                <td>
                                                <a class="btn btn-rounded btn-warning btn-sm" href="edit_member.php?id=<?=$row['id_member']?>">Edit</a>
                                                    <a class="btn btn-rounded btn-danger btn-sm" href="hapus_member.php?id=<?=$row['id_member']?> " onclick="return confirm('apakah anda yakin ingin menghapus data ini?');">hapus</a>                                                
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php } ?>
      ...
      <?php endif; ?>
            ...
            <footer class="footer">
              ...
              justify-content-sm-between">
                ...
                text-center">Copyright © 2021. All rights reserved.</span>
                </div>
            </footer>
            <!-- partial -->
        </div>
