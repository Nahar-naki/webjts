...
if (isset($_POST["submit"])) {
    ...
    $sql = mysqli_query($conect, "INSERT INTO `tb_member`(`id_member`, `nama`, `gambar`, `tgl_lahir`, `alamat`, `tentang_member`) VALUES ('','$nama','$newnama','$tgl_lahir','$alamat','$tentang_member')");
    if ($sql) {
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputEmail1" name="tgl_lahir" placeholder="Email">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="tentang" name="tentang_member" style="height:200px" ></textarea>
                                                </div>
                                                <!-- <div class="form-group">
